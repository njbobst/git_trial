...
$featurearray = array("Department/Program" => array("Economics","Government","Neuroscience","English","Engineering","African & African-American Studies","Environmental Studies","Biology","Computer Science"),
		      "Faculty Position being Considered For:" => array("Tenured Professor","Tenure-Track Assistant Professor","Untenured Visiting Instructor"),
		      "Race/Ethnicity" => array("Hispanic or Latino","American Indian or Alaska Native","Asian","Black or African American","Native Hawaiian or Other Pacific Islander","White"),
		      "Sex/Gender" => array("Male","Female"),
		      "Received PhD From:" => array("Yale University","Oxford University","University of Georgia","University of Michigan"),
		      "Received Undergraduate Degree From:" => array("Dartmouth College","Columbia University","Bowdoin College","University of California, Berkeley","University of Mississippi"),
		      "Spouse/Partner is a Current or Potential Faculty Member" => array("Yes","No"),
		      "Reputation as a Teacher" => array("Excellent","Good","Fair"),
		      "Reputation as a Researcher" => array("Excellent","Good","Fair"));
